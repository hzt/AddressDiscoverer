...
public class SingleRecordPerDivWeblinks implements IProgressConsumer {
    ...
    public static void setUpClass() {
        ...
        try {            
            ...
            String htmlUri = "/org/norvelle/addressdiscoverer/resources/fullpages/SingleRecordPerDivWeblinks.html";
    ...
    public void testCreateIndividuals() {
        ...
        try {            
            ...
            Assert.assertEquals("There should be 15 individiuals", 15, Individual.getCount());
            Assert.assertEquals("There should be 9 individuals without emails", 9, emailsNotFound);
            Assert.assertEquals("There should be 4 individuals with multiple emails", 4, multipleEmailsFound);

 ...
 */
public class SingleRecordPerLi implements IProgressConsumer {
    ...
    public void testCreateIndividuals() {
        ...
        try {            
            ...
            Assert.assertEquals("There should be 41 individiuals", 41, Individual.getCount());
            Assert.assertEquals("There should be 40 individuals without emails", 40, emailsNotFound);

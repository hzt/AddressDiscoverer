 ...
 */
public class SingleRecordPerLiNestedLis implements IProgressConsumer {
    ...
    public SingleRecordPerLiNestedLis() {
    }
    ...
    public static void setUpClass() {
        ...
        try {            
            ...
            String htmlUri = "/org/norvelle/addressdiscoverer/resources/fullpages/SingleRecordPerLiNestedLis.html";
    ...
    public void testCreateIndividuals() {
        ...
        try {            
            ...
            Assert.assertEquals("There should be 46 individiuals", 46, Individual.getCount());
            Assert.assertEquals("There should be 15 individuals without emails", 15, emailsNotFound);
            Assert.assertEquals("There should be 10 individuals with multiple emails", 10, multipleEmailsFound);
            Assert.assertEquals("There should be 21 individuals with single", 21, singleEmailsFound);
        } catch (Exception ex) {

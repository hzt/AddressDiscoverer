 ...
 */
public class MultipleTdsForSingleRecordPerTrThreeLinks implements IProgressConsumer {
    ...
    public MultipleTdsForSingleRecordPerTrThreeLinks() {
    }
    ...
    public static void setUpClass() {
        ...
        try {            
            ...
            String htmlUri = "/org/norvelle/addressdiscoverer/resources/fullpages/MultipleTdsForSingleRecordPerTrThreeLinks.html";
    ...
    public void testCreateIndividuals() {
        ...
        try {            
            ...
            Assert.assertEquals("There should be 30 individiuals", 3, Individual.getCount());
            ...
            Assert.assertEquals("There should be 2 individuals with single", 2, singleEmailsFound);
        } catch (Exception ex) {

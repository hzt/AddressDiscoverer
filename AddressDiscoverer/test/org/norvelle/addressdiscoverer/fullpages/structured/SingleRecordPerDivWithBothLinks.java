 ...
 */
public class SingleRecordPerDivWithBothLinks implements IProgressConsumer {
    ...
    public SingleRecordPerDivWithBothLinks() {
    }
    ...
    public static void setUpClass() {
        ...
        try {            
            ...
            String htmlUri = "/org/norvelle/addressdiscoverer/resources/fullpages/SingleRecordPerLiWeblinks.html";
    ...
    public void testCreateIndividuals() {
        ...
        try {            
            ...
            Assert.assertEquals("There should be 20 individiuals", 20, Individual.getCount());
            Assert.assertEquals("There should be 19 individuals without emails", 19, emailsNotFound);
            Assert.assertEquals("There should be 0 individuals with multiple emails", 0, multipleEmailsFound);
            Assert.assertEquals("There should be 1 individuals with single", 1, singleEmailsFound);
        } catch (Exception ex) {

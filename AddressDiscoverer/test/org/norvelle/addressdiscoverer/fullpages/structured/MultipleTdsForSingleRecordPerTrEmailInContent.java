 ...
 */
public class MultipleTdsForSingleRecordPerTrEmailInContent implements IProgressConsumer {
    ...
    public MultipleTdsForSingleRecordPerTrEmailInContent() {
    }
    ...
    public static void setUpClass() {
        ...
        try {            
            ...
            String htmlUri = "/org/norvelle/addressdiscoverer/resources/fullpages/MultipleTdsForSingleRecordPerTrEmailInContent.html";
    ...
    public void testCreateIndividuals() {
        ...
        try {            
            ...
            Assert.assertEquals("There should be 39 individiuals", 39, Individual.getCount());
            ...
            Assert.assertEquals("There should be 39 individuals with single", 38, singleEmailsFound);
        } catch (Exception ex) {

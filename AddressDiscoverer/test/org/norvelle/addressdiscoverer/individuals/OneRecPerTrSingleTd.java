 ...
 */
public class OneRecPerTrSingleTd implements IProgressConsumer {
    
    // A logger instance
    private static final Logger logger = Logger.getLogger(Logger.GLOBAL_LOGGER_NAME); 
    private static ConnectionSource connection;

    public OneRecPerTrSingleTd() {
    }
    ...
    /*
    @Test
    public void testAgenciso() {
        try {
            String htmlUri = "/org/norvelle/addressdiscoverer/resources/individuals/OneRecPerTrSingleTd.html";
            ...
            Assert.assertEquals("Name should be Dr. Agustín González Enciso", "Dr. Agustín González Enciso", nm.toString());
            ...
            Assert.assertEquals("Contact link should be agenciso@unav.es", "agenciso@unav.es", link.getAddress());

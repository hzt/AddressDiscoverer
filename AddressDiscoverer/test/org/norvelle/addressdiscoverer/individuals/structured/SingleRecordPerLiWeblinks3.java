 ...
 */
public class SingleRecordPerLiWeblinks3 implements IProgressConsumer {
    ...
    public SingleRecordPerLiWeblinks3() {
    }
    ...
    public static void setUpClass() {
        ...
        try {
            ...
            String htmlUri = "/org/norvelle/addressdiscoverer/resources/individuals/SingleRecordPerLiWeblinks3.html";
    ...
    public void testGetNameElement() {
        try {            
            ...
            Assert.assertEquals("Name should be Aguade Nieto, Santiago", "Aguade Nieto, Santiago", 
                    adeval.toString());
    ...
    public void testGetContactLink() {
        try {                        
            ...
            //Assert.assertEquals("[miportal@uah.es, miportal@uah.es, santiago.aguade@uah.es, ]santiago.aguade@uah....", emailAddress);

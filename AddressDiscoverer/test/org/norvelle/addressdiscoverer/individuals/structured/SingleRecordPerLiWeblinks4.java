 ...
 */
public class SingleRecordPerLiWeblinks4 implements IProgressConsumer {
    ...
    public SingleRecordPerLiWeblinks4() {
    }
    ...
    public static void setUpClass() {
        ...
        try {
            ...
            String htmlUri = "/org/norvelle/addressdiscoverer/resources/individuals/SingleRecordPerLiWeblinks4.html";
    ...
    public void testGetNameElement() {
        try {            
            ...
            Assert.assertEquals("Name should be Alvarado Marambio, José Tomás", "Alvarado Marambio, Jose Tomas", 
                    adeval.toString());
    ...
    public void testGetContactLink() {
        try {                        
            ...
            StructuredPageContactLinkLocator.baseUrl = "http://filosofia.uc.cl/index.php?option=com_content&view=category&layout=blog&id=4&Itemid=9";
            String emailAddress = cl.getAddress();
            //Assert.assertEquals("jalvaram@uc.cl", emailAddress);

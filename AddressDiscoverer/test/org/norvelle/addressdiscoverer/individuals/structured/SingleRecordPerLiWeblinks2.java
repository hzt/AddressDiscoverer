 ...
 */
public class SingleRecordPerLiWeblinks2 implements IProgressConsumer {
    ...
    public SingleRecordPerLiWeblinks2() {
    }
    ...
    public static void setUpClass() {
        ...
        try {
            ...
            String htmlUri = "/org/norvelle/addressdiscoverer/resources/individuals/SingleRecordPerLiWeblinks2.html";
    ...
    public void testGetNameElement() {
        try {            
            ...
            Assert.assertEquals("Name should be Albisu Barandiaran, Josune", "Albisu Barandiaran, Josune", 
                    adeval.toString());
    ...
    public void testGetContactLink() {
        try {                        
            ...
            StructuredPageContactLinkLocator.baseUrl = "https://www.ehu.es/bilatu/buscar/seekuser.php?lang=es&amp;u=c2dwYWxiYWo=";
            String emailAddress = cl.getAddress();
            Assert.assertEquals("josune.albisu@ehu.es", emailAddress);
